...
# The Remix
- The availability of genetic association data is much wider
...
- Upload this as a comment to the original PLoS article
- ALOX5AP's SNPs have changed names, haven't checked the remainder (silent errors?)
- Next steps: getting directionality tests to work, better displays of the evidence
